...
def handle_message(data):
    ...
    socketio.emit('receive_response', data, to=current_user.id)
...
def start_chat(user_id, user_message): 
    ...
    socketio.emit('chat_started', data, to=current_user.id)
...
def open_chat(chat_id):
    ...
    socketio.emit('chat_opened', messages, to=current_user.id)
...
def update_stats(startdate, enddate):
    ...
    socketio.emit('updated_stats', stats, to=current_user.id)
