...
def pdb_setup():
    ...
    cursor.execute("DROP TABLE [AI:Lean].[dbo].[product_database]")
    conn.commit()

    print("---------------------------------------------------------------------------------------------------------------")
    print("Creating new table")

    cursor.execute("SELECT * INTO [AI:Lean].[dbo].[product_database] FROM [AI:Lean].[dbo].[product_database_staging]")
    conn.commit()
    ...
    cursor.execute("SELECT DISTINCT name_of_camera, name_of_feature, value_of_feature FROM [AI:Lean].[dbo].[product_database_staging] WHERE value_of_feature "
